...
class exchange
{
    ...
    {
        $sql = 'SELECT COUNT(*) FROM ' .$this->table. " WHERE $col = '$name'"." and sysid ='".$GLOBALS['sysid']."' ";
    ...
    {
        $sql = 'UPDATE ' . $this->table . ' SET ' . $set . " WHERE $this->id = '$id'"." and sysid ='".$GLOBALS['sysid']."' ";
    ...
    function get_name($id, $name = '')
    {
        ...
        $sql = "SELECT `$name` FROM " . $this->table . " WHERE $this->id = '$id'"." and sysid ='".$GLOBALS['sysid']."' ";
    ...
    function drop($id)
    {
        $sql = 'DELETE FROM ' . $this->table . " WHERE $this->id = '$id'"." and sysid ='".$GLOBALS['sysid']."' ";
