...
///* 插件的 library */
//$sql = 'SELECT code, library FROM ' . $yke->table(1,'plugins') . " WHERE assign = 1 AND library > ''"." and sysid ='".$GLOBALS['sysid']."' ";
//$res = $db->query($sql);
//
...
{
    $sql = 'SELECT code, library FROM ' . $GLOBALS['yke']->table(1,'plugins') . " WHERE library > ''"." and sysid ='".$GLOBALS['sysid']."' ";
