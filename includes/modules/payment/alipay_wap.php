...
class alipay_wap
{
    ...
    function get_code($order, $payment)
    {
        ...
        $req_data = '<direct_trade_create_req>'
                ...
                . '<merchant_url>'. $GLOBALS['yke']->url() .'</merchant_url>'
        ...
        $button = '<div style="text-align:center"><input type="button" onclick="window.open(\''.$gateway.$param. '&sign='.md5($sign).'\')" value="确认支付" class="c-btn3" /></div>';
        return $button;
    }
	...
	{
		return $GLOBALS['yke']->url() . 'notify/alipay_wap.php';
	}
