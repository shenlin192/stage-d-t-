...
/**
 * YKESHOP SQL语句执行类。在调用该类方法之前，请参看相应方法的说明。
 * ============================================================================
...
class sql_executor
{
     ...
     * @return  void
     */
    function __construct($db, $charset = 'gbk', $sprefix = 'yke_', $tprefix = 'yke_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
     ...
     * @return  void
     */
    function sql_executor($db, $charset = 'gbk', $sprefix = 'yke_', $tprefix = 'yke_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
        $this->db = $db;
