...
function sendsms_imtong($mobile, $content)
{
	...
	$sendurl = "http://".$smsapi."/".$charset."/interface/send_sms.aspx?username=".$GLOBALS['_CFG']['YKEdxt_user_name']."&password=".$GLOBALS['_CFG']['YKEdxt_pass_word']."&receiver=".$mobile."&content=".urlencode($content)."";
