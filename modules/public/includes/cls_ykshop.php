...
define('APPNAME', 'YKESHOP');
define('VERSION', 'v3.6.2');
define('RELEASE', '20160331');
...
class YKE
{
     ...
     * @return  string
     */
    function table($yke=1,$str, $adm = 0)
    {
		if ($str == "ykesmart_shop_config" && $adm == 0)
		{
