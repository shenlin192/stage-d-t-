...
//            echo "<pre>".print_r(mcrypt_list_modes())."</pre>";        }
         ...
         * @param $key 密钥
         */
            public function encode($key,$destr) {
                ...
                //要保存到明文
                $con='tode='.$destr;//.'&ip='.$this->mac_addr.'@lt='.$this->ttl;
                //bedecode=abcd0123&ip=B8-EE-65-D5-6C-DA@lt=20170619
               //echo $con;
                //加密
             ...
             * @param $key 密钥
             */
        public function decode_str($key,$str) {
                    $secret=$str;
    ...
    $code=new cls_des();
    //加密
    $code->encode("~!@#$%!@#$%^",'abcd0123');//
    echo $code->encode;
    //解密
    echo $code->decode_str("~!@#$%!@#$%^",$code->encode);
?>