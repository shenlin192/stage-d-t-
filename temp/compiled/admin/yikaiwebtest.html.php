...
<head>
    ...
    <link rel="stylesheet" href="/<?php echo $this->_var['project_path']; ?>/styles/global/jquery.ui.rotatable.css">
    <link rel="stylesheet" href="/<?php echo $this->_var['project_path']; ?>/styles/global/index1.css">

    <link rel="stylesheet" href="/<?php echo $this->_var['project_path']; ?>/styles/global/jquery.contextMenu.css" type="text/css" media="screen">
    ...
    <script src="/<?php echo $this->_var['project_path']; ?>/js/jquery.ui.position.min.js"></script>
...
<script>
    ...
    var templateInfo1=<?php echo $this->_var['elements_type']; ?>;
    ...
    var pageInfo=<?php echo $this->_var['elements_detail']; ?>;
